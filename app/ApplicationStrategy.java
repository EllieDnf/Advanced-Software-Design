...
import Advanced_Software_Design.lab1_strategyPattern.*;

public class ApplicationStrategy {
	public static void main(String[] args) {
		AccountService accountService = new AccountServiceImpl();
		AccType checking = new AccChecking();
		AccType saving = new AccSaving();
		...
		for (Account account : accountService.getAllAccounts()) {
			...
			System.out.print("Account type: "+account.getAccType().getClass().getSimpleName());
			System.out.println("    rate is: "+account.getAccType().intrest(account.getBalance())+"%");
